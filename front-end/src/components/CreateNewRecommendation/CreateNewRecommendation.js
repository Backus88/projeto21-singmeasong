...
export default function CreateNewRecommendation({ onCreateNewRecommendation = () => 0, disabled = false }) {
  ...
  return (
    <Container>
      ...
      <Input data-cy = "link" type="text" placeholder="https://youtu.be/..." value={link} onChange={e => setLink(e.target.value)} disabled={disabled} />
      <Button data-cy= "button" onClick={() => handleCreateRecommendation()} disabled={disabled}>
